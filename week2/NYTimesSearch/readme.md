...
* [x] User can tap on any article in results to view the contents in an embedded browser. (Chrome Tabs)
...
- Added Splash Screen
- Added Android icon for the app
- Added Optimization where a search will not be triggered if it's the same query string and filters have not changed
- Application itself only really has two activity that uses a dialog fragment and chrome tab instead of the webview and one for the splash screen.

## Video Walkthrough

Here's a walkthrough of implemented user stories:

<img src='https://github.com/darewreck54/android/blob/master/week2/NYTimesSearch/gif/nytime_v2_2.gif' title='NYTimesSearch Video Walkthrough' width='' alt='Video Walkthrough' />
...
- working with the relative layout and getting the UI layout correct

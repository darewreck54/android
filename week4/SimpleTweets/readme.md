...
* [x] Leverages the [data binding support module](http://guides.codepath.com/android/Applying-Data-Binding-for-Views) to bind data into layout templates.
      This was implemented origianlly, but decided to go with butterknife instead because it was more straightforward
...
[x] splash/icon screen
[x] toggle icon clicks with selectors
[x] Add logic to handle and display errors from the Twitter API

## Video Walkthrough

Here's a walkthrough of implemented user stories:

<img src='https://github.com/darewreck54/android/blob/master/week4/SimpleTweets/gif/simpleTweets1.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />

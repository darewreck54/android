...
<img src='https://github.com/darewreck54/android/blob/master/week3/SimpleTweets/gif/simpleTweetsOffline.gif' title='Offline mode' width='' alt='Video Walkthrough' />
<img src='https://github.com/darewreck54/android/blob/master/week3/SimpleTweets/gif/simpleTweetsOnline.gif' title='Online mode' width='' alt='Video Walkthrough' />
<img src='https://github.com/darewreck54/android/blob/master/week3/SimpleTweets/gif/simpleTweetsOnline2.gif' title='Online mode' width='' alt='Video Walkthrough' />
...
- The documentation for the twitter API wasn't straight forward.  Example What API does reply match to?  Also the Twitter API dev console does a poor job at displaying the response.
- Finding corresponding images and working with image sizes
- Couldn't get VideoPlayManager working properly.  
- Also creating round edges with Glide is not as straight forward like it is with Picasso
- Also found that ButterKnife was better then using the probided data bind library.  It was more intuitive and easier to map to on click actions.
